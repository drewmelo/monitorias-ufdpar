...
Acesse o arquivo **main.pdf**, que está dentro da pasta *atividade*, localizada em *"tecnicas-pesquisa-economia"* no repositório *monitorias-ufdpar*, ou clique [aqui](https://github.com/drewmelo/introducao-R/blob/master/atividade/atividade.pdf) para acessá-lo diretamente.
